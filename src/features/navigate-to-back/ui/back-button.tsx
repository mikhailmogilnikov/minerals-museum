    ...
    <AnimatePresence>
      {isBackableRoute && (
        <m.button
          ...
          whileTap={{ scale: 0.95 }}
          className='backdrop-blur-2xl bg-default/70 shadow-base fixed flex gap-2 items-center top-4 left-4 md:top-10 md:left-10 rounded-full pl-2 pr-4 py-1 z-40 font-medium text-md md:text-lg'
          onClick={handleClick}
        >
