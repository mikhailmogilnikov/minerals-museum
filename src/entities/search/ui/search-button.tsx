...
export const SearchButton = () => {
  ...
  return (
    <>
      <Button
        onPress={handleOpen}
        className='w-full sm:w-56 h-14 bg-default/80 rounded-full backdrop-blur-xl flex items-center justify-start gap-4 px-6 shadow-base data-[hover]:opacity-100'
      >
